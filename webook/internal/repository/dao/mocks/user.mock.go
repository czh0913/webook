...
import (
	...
	dao "github.com/czh0913/gocode/basic-go/webook/internal/repository/dao"
...
func (m *MockUserDAO) FindByWeChat(ctx context.Context, union string) (dao.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByWeChat", ctx, union)
	ret0, _ := ret[0].(dao.User)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUserDAOMockRecorder) FindByWeChat(ctx, union any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByWeChat", reflect.TypeOf((*MockUserDAO)(nil).FindByWeChat), ctx, union)
}
